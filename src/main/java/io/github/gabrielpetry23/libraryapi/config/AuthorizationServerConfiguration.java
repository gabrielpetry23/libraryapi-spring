...
public class AuthorizationServerConfiguration {
    ...
    // Classe responsável pela configuração do servidor de autorização OAuth2.

    @Bean
    @Order(1)
    public SecurityFilterChain authServerSecurityFilterChain(HttpSecurity http) throws Exception {
        OAuth2AuthorizationServerConfiguration.applyDefaultSecurity(http); // Configura o servidor de autorização OAuth2 com as configurações padrão
